...
DCE (pthread_attr_setstacksize)
NATIVE (pthread_attr_setguardsize)
DCE (pthread_getcpuclockid)
DCE (pthread_getattr_np)
DCE (pthread_attr_getstack)
...
// SETJMP.H
NATIVE_WITH_ALIAS2 (setjmp, _setjmp)
NATIVE (__sigsetjmp)
NATIVE (siglongjmp)

// LIBINTL.H
NATIVE (bindtextdomain)
NATIVE (bind_textdomain_codeset)
NATIVE (textdomain)
NATIVE (gettext)
NATIVE (catopen)
NATIVE (catgets)
